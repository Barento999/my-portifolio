  ...
  const timeline = [
    {
      ...
      period: "2023 - Present",
      description:
        "Studying software engineering with focus on web development, algorithms, and system design. Actively participating in coding competitions and tech communities.",
      highlights: [
    ...
    },
    {
      ...
      period: "2024 - Present",
      description:
        "Built multiple full-stack applications using MERN stack for coursework and personal learning. Focused on creating scalable, user-friendly solutions.",
      highlights: [
        "E-commerce platform with Firebase authentication",
        "Project management system with real-time updates",
        "REST API services with JWT authentication",
    ...
    },
    {
      ...
      period: "2022 - Present",
      description:
        "Continuously learning through online courses, documentation, and hands-on projects. Building real-world applications to solidify knowledge.",
      highlights: [
