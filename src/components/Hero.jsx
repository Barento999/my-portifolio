  ...
  return (
    <section
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-primary-300 to-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
        <div className="absolute top-40 right-10 w-96 h-96 bg-gradient-to-r from-purple-300 to-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-20 w-96 h-96 bg-gradient-to-r from-pink-300 to-primary-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="w-full relative z-10">
        <div className="text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-4 gradient-text animate-fade-in-up drop-shadow-lg">
            Barento Hashum
          </h1>
          ...
          <h2 className="text-2xl md:text-3xl mb-6 h-12 animate-fade-in-up animation-delay-200">
            ...
            <span className="text-gray-700 animate-pulse font-bold">|</span>
          </h2>

          <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-8 animate-fade-in-up animation-delay-400 leading-relaxed">
          ...
          <div className="flex justify-center gap-4 animate-fade-in-up animation-delay-1000">
            <a
              ...
              className="w-12 h-12 glass-effect rounded-xl flex items-center justify-center text-gray-700 hover:text-white hover:bg-gradient-to-br hover:from-gray-800 hover:to-gray-900 hover:scale-110 hover:shadow-lg transition-all duration-300 group">
              <Github
                size={22}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 glass-effect rounded-xl flex items-center justify-center text-gray-700 hover:text-white hover:bg-gradient-to-br hover:from-blue-600 hover:to-blue-700 hover:scale-110 hover:shadow-lg transition-all duration-300 group">
              <Linkedin
                size={22}
                className="group-hover:rotate-12 transition-transform"
              />
            ...
            <a
              ...
              className="w-12 h-12 glass-effect rounded-xl flex items-center justify-center text-gray-700 hover:text-white hover:bg-gradient-to-br hover:from-pink-600 hover:to-rose-600 hover:scale-110 hover:shadow-lg transition-all duration-300 group">
              <Mail
                size={22}
                className="group-hover:rotate-12 transition-transform"
              />
